...
public class CastDataAdapter extends RecyclerView.Adapter<CastDataAdapter.VisualMediaAdapterViewHolder> {
   ...
   public class VisualMediaAdapterViewHolder extends RecyclerView.ViewHolder
    ...
    @NonNull
    @Override
    public CastDataAdapter.VisualMediaAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(@NonNull VisualMediaAdapterViewHolder adapterViewHolder, int position) {
        ...
        CastData currentVisualMediaData = mAdapterData.get(position);
...
//    }
    ...
    public void addAdapterData(List<CastData> visualMediaDataList) {
        mAdapterData.addAll(visualMediaDataList);
        notifyDataSetChanged();
    }

    public CastData getVisualMediaData(int index) {
        return mAdapterData.get(index);
    }

    public List<CastData> getVisualMediaDataList() {
        return mAdapterData;
    }
